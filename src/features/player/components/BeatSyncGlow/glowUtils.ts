...
export const getGlowStyle = (_category: ThemeCategory, intensity: number, beatLevel: number) => {
	...
	const shadowOpacity = Math.min(baseOpacity + safeBeat * 0.3, 1.0); // 비트 레벨에 비례
